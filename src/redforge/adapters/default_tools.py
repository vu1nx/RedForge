...
from redforge.adapters.nuclei import NUCLEI_TOOL
from redforge.adapters.subfinder import SUBFINDER_TOOL
from redforge.adapters.technology_detection import WHATWEB_TOOL
...
def create_default_tool_registry() -> ToolRegistry:
    ...
    return ToolRegistry(
        (HTTPX_TOOL, KATANA_TOOL, NUCLEI_TOOL, SUBFINDER_TOOL, WHATWEB_TOOL)
    )
